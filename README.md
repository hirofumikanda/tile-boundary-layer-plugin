...
3. **ZIPファイルからインストール** タブを選択
4. `tile_layer_plugin.zip` ファイルを選択してインストール
5. **インストール済み** タブで「Tile Boundary Layer」を有効化

### 方法2: 手動インストール

1. QGISプラグインディレクトリを開く：

2. `tile_layer_plugin` フォルダを上記ディレクトリにコピー
